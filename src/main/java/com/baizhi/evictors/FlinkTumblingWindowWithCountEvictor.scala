...
object FlinkTumblingWindowWithCountEvictor {
  def main(args: Array[String]): Unit = {
    ...
    val counts = text.flatMap(_.split("\\s+"))
      ...
      .apply(new UserDefineTumblingWindowFunction)
      .print()
...
class UserDefineTumblingWindowFunction extends AllWindowFunction[String,String,TimeWindow]{
